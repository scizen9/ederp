pro ecwi_cflat_anal,imgno
;+
;	ecwi_cflat_anal - analyze continuum flat images for charge transfer
;-
pre = 'ECWI_CFLAT_ANAL'
;
img = mrdfits('image'+strn(imgno)+'.fits',0,hdr,/fscale)
ecwi_map_ccd,hdr,asec,bsec,csec,tsec,namps=namps,trimmed_size=tsz
osx0 = bsec[0,0,0] + 20
osx1 = bsec[0,0,1] - 20
