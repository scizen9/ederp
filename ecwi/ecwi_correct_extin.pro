...
;
; CALLING SEQUENCE:
;	ECWI_CORRECT_EXTIN, Img, Hdr, Ppar
;
; INPUTS:
...
;-
pro ecwi_correct_extin,img,hdr,ppar
;
; setup
pre = 'ECWI_CORRECT_EXTIN'
;
; get airmass
...
;	exma - extinction in magnitudes per airmass
	...
	ecwi_print_info,ppar,pre,'No extinction curve for telescope', $
