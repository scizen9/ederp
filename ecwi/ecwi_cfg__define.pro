...
;	information for ECWI raw data read from the raw headers.
;
; CATEGORY:
...
;
; SIDE EFFECTS:
;	defines the ECWI_CFG data structure
;
; PROCEDURE:
;	Provide the automatic structure definition for the ECWI raw header
;	observation structure ECWI_CFG.
;
; EXAMPLE:
;	Instantiate and initialize a single cfg struct for ECWI:
;
;	ecfg = {ecwi_cfg}
;	ecfg = struct_init(ecfg)
;
; NOTES:
