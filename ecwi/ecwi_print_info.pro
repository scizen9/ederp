...
;
; CALLING SEQUENCE:
;	ECWI_PRINT_INFO,Ppar,Pre,Msg,Var1,Var2...
;
; INPUTS:
;	Ppar	- array of struct ECWI_PPAR pipeline parameters
...
;-
pro ecwi_print_info,ppar,ipre,msg,v1,v2,v3,v4,v5,v6,v7,v8,v9, $
	...
	if size(ipre,/type) ne 7 then begin
		print,'ECWI_PRINT_INFO: Error - input pre string error, returning'
		return
	endif
	;
	...
	if np gt 0 then begin
		...
		case np of
			...
			else: print,'ECWI_PRINT_INFO [ERROR] variable overflow'
		endcase
	endif
	;
	; check logging first
